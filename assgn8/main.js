...
var tl6 = new TimelineMax({onUpdate: updatePercentage}); //benefits-1-image//
var tl7 = new TimelineMax({onUpdate: updatePercentage}); //benfits details (first half)//
var tl8 = new TimelineMax({onUpdate: updatePercentage});
var tl9 = new TimelineMax({onUpdate: updatePercentage});
var tl10 = new TimelineMax({onUpdate: updatePercentage});
var tl11 = new TimelineMax({onUpdate: updatePercentage}); //benefits-2-image//
var tl12 = new TimelineMax({onUpdate: updatePercentage}); //benefits details (second half)//
var tl13 = new TimelineMax({onUpdate: updatePercentage});
var tl14 = new TimelineMax({onUpdate: updatePercentage});
var tl15 = new TimelineMax({onUpdate: updatePercentage});
...
tl14.from(".dz-benefits-07", .5, {x:200, opacity: 0});
tl15.from(".dz-benefits-08", .5, {x:200, opacity: 0});
...
const scene6 = new ScrollMagic.Scene({ //benefits-01-image//
    triggerElement: ".dz-benefits",
    triggerHook: "40%"
})
    .setTween(tl6)
...
const scene11 = new ScrollMagic.Scene({ //benefits-02-image//
    triggerElement: ".dz-benefits-2-image",
    triggerHook: "40%"
})
    .setTween(tl11)
      .addTo(controller);
